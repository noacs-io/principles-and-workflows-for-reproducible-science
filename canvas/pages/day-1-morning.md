...
Also fix these in your notes: the 5-year test; that afternoon is hybrid (room **Future** + [Zoom](https://ki-se.zoom.us/j/68142022512)); that the DMP you draft feeds **assignment component 1** (protocol = component 2, elsewhere in the course).

---

## 2. AI block (required) — outcome 5

You may use AI when you build your own folder in the afternoon. Read this **before** that drafting.
...
## 3. SRC template + today’s paste targets (required) — outcome 4

Download `Swedish_Research_Council_Template__v5.docx` from Canvas **Files**. Today’s afternoon pastes (mark as *draft*):

| Area | SRC question (short) |
|------|----------------------|
| **Data description** | How will data be collected, created or reused? What types/formats/volume? |
| **Documentation** | How will the material be documented and described (metadata, structure, collection method)? |

Day 2 covers data quality, storage, security, and who is responsible.
...
Jot short notes for the iRAT (definition vs KI aims; raw vs derived; FAIR vs open; ELN vs project folder). Folder critique and DMP paste happen in the afternoon — not this morning.
