# Day 2 afternoon — Team-Based Learning
...
**Default for shared text:** one master in **Office Online** on a KI Teams/SharePoint project site; download into the project folder regularly; name exports. Google Docs or personal OneDrive are fine for shared text if your group prefers them. If you are not co-writing online, dated copies plus a decision log still work. Git is fine if you already use it.

Restricted research **data** still belongs on [KI-approved storage](https://staff.ki.se/research-support/research-data-management/create-collect-store-research-data). That is separate from which editor you use for ordinary shared text.
...
1. **Alone first (≈10 min).** For *your* study, write down:
   ...
   - Draft answers in the [SRC template](../files/Swedish_Research_Council_Template__v5.docx) under **storage** and **security**.
...
3. As a team, post **2–3 tensions or unclear points** on the shared board. One short line each is enough (for example: “Unclear whether interview transcripts can sit in the shared Office Online master”). Name the study type if it helps (survey / qualitative / trial).
...
2. If you use AI: prefer Microsoft Copilot because it is supported by KI and disclose use to your team.
3. Use your documentation work to draft answers under **data quality** and **who is responsible** in the [DMP template](../files/Swedish_Research_Council_Template__v5.docx).
