...
Upload this `.docx` to the Canvas course **Files** area, then link it from [`../pages/module-overview.md`](../pages/module-overview.md) and the day pages.

See [`../README.md`](../README.md) for the five-page module (issue #10 / D040).
