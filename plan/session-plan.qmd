...
| Application | **App 1:** unlabelled folder critique with the **full** 5-year rubric → team posts **2–3 findings** → whole-group discussion. **App 2:** own folder + README; paste **data description** / **documentation**; light within-team check → **2–3 findings** → whole-group discussion | **App 1:** alone → team → **2–3 findings** (tensions OK) → whole-group discussion; paste **storage** / **security**. **App 2:** own package + AI docs; paste **data quality** / **who is responsible**; full within-team rubric → **2–3 findings** → whole-group discussion |
| Closure | Whole-group discussion of App 1 and App 2 board posts; common pitfalls; revisit Session → DMP map (in this plan) | Whole-group discussion of App 1 and App 2 board posts; peer-critique themes; handover checklist; partial DMP for the assignment |
...
Student-facing copy: [`canvas/pages/five-year-rubric.md`](../canvas/pages/five-year-rubric.md). Use the **full** guide in Day 1 App 1 and again in the Day 2 peer critique. Do not force a row-by-row walk in the exercises in between (D048). Discussion questions only; no pass/fail (D046).
