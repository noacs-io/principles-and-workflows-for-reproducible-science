...
| Application | **App 1:** unlabelled folder critique against the **5-year rubric** → short findings on a shared board. **App 2:** own folder + README; paste **data description** and **documentation**; within-team peer critique (each presents, then discuss) | **App 1:** readable history + sharing limits; paste **storage** and **security**. **App 2:** own package + AI docs; paste **data quality** and **who is responsible**; within-team peer critique |
