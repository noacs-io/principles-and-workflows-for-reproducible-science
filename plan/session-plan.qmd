...
It is a working plan for a **small teaching team (four people)** that must be **ready in 8 days** (target: **2026-09-22**): what to align to, which resources to reuse, which KI tools to use, how AI enters the workflow, and a short must-ship backlog tracked as GitHub issues.
...
6. **Draft** answers for key sections of a data management plan (Swedish Research Council template) from their project package — especially data description, documentation/quality, storage, and responsibilities.
...
### Recommendation for this build (8 days)
...
# What to build (8 days, team of four)

**Ready-by date: 2026-09-22** (8 days from 2026-09-14). Keep the backlog small. Aim for a **runnable first offering**, not a complete course platform. Park nice-to-haves for later.

Each must-ship item is a **GitHub issue**. Prefer finishing Day 1–4 build work early so Days 5–7 can smoke-test and Day 8 is buffer.

## Suggested calendar

| Day | Date | Focus |
|-----|------|-------|
| 1 | 2026-09-15 | Scope lock; freeze ILOs/rubric; pick TBL delivery |
| 2 | 2026-09-16 | Day 1–2 run sheets; Canvas shell |
| 3 | 2026-09-17 | Example folders + templates; student DMP note |
| 4 | 2026-09-18 | TBL items + application exercises |
| 5 | 2026-09-19 | AI rules/prompts/demo; submission instructions |
| 6 | 2026-09-20 | Canvas publish + readings; SRC template linked |
| 7 | 2026-09-21 | End-to-end dry run / Day-0 checklist |
| 8 | 2026-09-22 | Buffer: fix gaps; ready |
...
## Must ship (tracked as issues)

- [ ] #6 Scope lock: dates, rooms, compulsory bits, DMP workshop framing
- [ ] #7 Canvas + template: SRC template in Canvas; point to Session → SRC DMP map in this plan
- [ ] #8 Freeze ILOs + 5-year rubric (good enough, not polished exemplars)
- [ ] #9 Day 1–2 run sheets with explicit “paste into SRC DMP” steps; dual track Git *or* dated decision log
- [ ] #10 Canvas module: readings (required vs optional), tasks, submission place
- [ ] #11 Examples + templates: one good + one poor synthetic project folder; README / DECISIONS / data-dictionary templates
- [ ] #12 Student note: how the project package feeds the SRC DMP (and what belongs in the protocol instead)
- [ ] #13 TBL content: Day 1–2 iRAT/tRAT items + 1–2 application exercises (Markdown/CSV); include at least one DMP-mapping application
- [ ] #14 TBL delivery choice for this run (InteDashboard **or** Canvas quizzes + Padlet **or** quick open-source pilot); log in `DECISIONS.md`
- [ ] #15 AI package: short student rules, 4–6 prompts for folder/README/decision log/DMP drafts, Copilot demo with one wrong answer
- [ ] #16 Submission instructions: project package (zip/repo) + partial DMP + AI disclosure
- [ ] #17 Day-0 checklist: rooms + power; Canvas published; TBL smoke-tested; Copilot on demo machine

Open issues: <https://github.com/noacs-io/principles-and-workflows-for-reproducible-science/issues?q=is%3Aissue+is%3Aopen+%228-day%22>
