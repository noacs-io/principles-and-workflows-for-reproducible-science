...
- [ ] **#10** Canvas module: both self-study morning packs (required vs optional), SRC template + **Session → SRC DMP map**, the student note on project package → DMP versus protocol, and the submission place — *drafts in [`canvas/`](../canvas/); publishing to the course room still required*
...
- [ ] **#13** TBL content: conceptual iRAT/tRAT banks for both days [Martin] plus the Day 1 and Day 2 application exercises (Markdown/CSV, tool-agnostic)
