...
1. Read: **Good Enough Practices, Part B** and the Day 2 readings named in the brief — change tracking; KI share/collaborate + open-access policy; metadata vs raw data. No separate versioning mini-lesson (D031).
...
- [ ] **#10** Canvas module: both self-study morning packs (required vs optional), SRC template + **Session → SRC DMP map** (six areas, D023), the student note on project package → DMP versus protocol, and the course assignment checklist (no session hand-in, D022) — *drafts in [`canvas/`](../canvas/) (D037); publishing to the course room still required (#17)*
