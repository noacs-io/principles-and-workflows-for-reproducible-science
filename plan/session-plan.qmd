...
Design and tooling choices are recorded in [`DECISIONS.md`](DECISIONS.md).
...
4. Record the final choice in `plan/DECISIONS.md`.
...
| Decision logging | `plan/DECISIONS.md` in this repo |
...
- [ ] Decide delivery stack: InteDashboard, LAMS, gRATify+Canvas, or hybrid (log in `plan/DECISIONS.md`)
...
7. **Log platform and pedagogy decisions** in `plan/DECISIONS.md`.
...
- Decision log for this project: [`plan/DECISIONS.md`](DECISIONS.md)
