...
- [ ] **#10** Canvas module: **five** student pages (overview + Day 1/2 morning + Day 1/2 afternoon; D040), SRC template in Files, paste targets on each day page — *drafts in [`canvas/`](../canvas/); publishing to the course room still required (#17)*
