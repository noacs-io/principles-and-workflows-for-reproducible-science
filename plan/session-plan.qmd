...
| SRC template section | What students produce in these sessions | Directly usable in the DMP? |
|----------------------|-------------------------------------------|----------------------------|
| **General information** | Project title, people, dates in README | Yes — copy into header fields |
| **Description of data** — how collected/created/reused | Methods note in README; decision log on reuse vs new data | Yes — draft answers for collection/reuse and provenance |
| **Description of data** — types, formats, volume | Folder tree; file-type inventory; naming conventions | Yes — formats, organisation, approximate volume |
| **Documentation and data quality** — metadata & organisation | README, `DECISIONS.md`, data-dictionary stub, folder conventions | **Strong fit** — organisation, versioning, accompanying docs |
| **Documentation and data quality** — quality safeguards | Notes on checks, validation, peer review of docs | Partial — quality *of data handling/docs*; collection QC mainly in the protocol |
| **Storage and backup** | Storage location note; raw vs derived separation; backup habits | Yes — during-project storage/backup narrative |
| **Storage and backup** — security / controlled access | What must *not* go in public repos or AI prompts; access notes | Yes — especially personal/sensitive data handling |
| **Legal and ethical aspects** | Sharing limits; GDPR-aware AI use; consent/location of ethics docs | Supporting drafts — students still check with KI support functions |
| **Accessibility and long-term storage** | 5-year interpretability; what could be shared later vs metadata-only | Supporting drafts — repository choice may come later |
| **Responsibility and resources** | Roles in README (who owns folder, docs, DMP updates) | Yes — roles during/after the project |
...
3. Transfer today’s text into the matching section(s), marked as *draft for assignment*.

Provide a one-page handout: **“Session → SRC DMP section map”** ([`assignment/session-to-dmp-map.md`](../assignment/session-to-dmp-map.md)). Day 2 submission = project package **plus** a partially completed DMP (at least the documentation, data description, and storage sections).
...
| Application | Teams design a folder + README for a shared vignette; sketch answers for SRC “description of data” + “documentation” | Teams work on *their* PhD project package; draft/paste into SRC DMP sections; peer review against the 5-year rubric |
...
3. Team application: design folder + README for a shared global-health vignette; **write draft bullets for SRC sections “Description of data” and “Documentation and data quality.”**
...
3. **Paste/adapt** today’s materials into the SRC template (or DMPonline): at least documentation, data description, and storage — mark as *draft*.
