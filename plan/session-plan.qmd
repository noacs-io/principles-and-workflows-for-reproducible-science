...
|-------------|-------------|-------------|
| Pre-work | Definition + caveats; KI rules; **AI rules (Copilot-first)**; read **Good Enough Practices Part A**; FAIR videos | Read **Good Enough Practices Part B** (versioning + sharing); prepare own package for afternoon apps |
...
| Application | **App 1:** good vs poor folder critique → short findings on a shared board. **App 2:** own folder + README; paste **data description** and **documentation**; peer critique | **App 1:** readable history + sharing limits; paste **storage** and **security**. **App 2:** own package + AI docs; paste **data quality** and **who is responsible**; peer critique |
| Closure | Sample App 1 board posts; common pitfalls; revisit Session → DMP map (in this plan) | Sample App 1 board posts; peer-critique themes; handover checklist; partial DMP for the assignment |
...
2. **AI rules before App 2:** Copilot-first; no sensitive data in prompts; keep prompt + output; verify; disclose ([KI Generative AI and Education](https://staff.ki.se/tools-and-support/ai-at-ki/generative-ai-and-education); full package #15).
...
4. Read: **Good Enough Practices, Part A** and the KI guidelines named in the brief ([Riktlinjer för forskning](https://medarbetare.ki.se/media/99275/download) §§6–7; documentation and data management guidelines).
5. FAIR videos (as in the brief).
...
3. Application 1: compare good vs poor synthetic project folder — each team posts short findings to a shared board (hybrid-friendly); facilitator samples contrasts.
...
5. Inter-team peer critique with rubric (clarity, longevity, ethics, findability) — packages differ; score against the rubric.
...
1. Read: **Good Enough Practices, Part B** and the Day 2 readings named in the brief — change tracking, sharing and DOIs, licensing and citation. No separate versioning mini-lesson (D031).
...
2. Application 1: readable history + sharing/access limits for *your* project; shared-board posts; paste **storage** and **security**.
3. Application 2: refine folder + README / decision log (manual or Copilot); paste **data quality** and **who is responsible**.
4. Inter-team peer critique against the **5-year rubric** *and* “Could a classmate find matching text in your DMP draft?”
...
- [ ] **#11** Materials pack: one good + one poor synthetic project folder [Johanna] (**Day 1 afternoon App 1**, D029), README / decision-log / data-dictionary templates, and the **5-year rubric**
...
- [ ] **#15** AI package: student rules, prompts for Day 1 App 2 and Day 2 App 2 (README / decision log), a demo that includes one wrong answer, and the disclosure template — *Day 1 morning must already carry the Copilot-first / data-safety / disclose rules (D028) even if this package is incomplete*
...
| TBL tool not ready | Default to Canvas quiz for iRAT/tRAT; App reporting via Padlet/shared board + peer critique (D030) |
