...
| iRAT / tRAT | Concepts: raw vs derived; README; decision log; FAIR vs open; method-agnostic documentation bar — item bank in [`tbl/day-1-irat.md`](../tbl/day-1-irat.md) | Versioning; collaboration; AI disclosure; ethical sharing boundaries — item bank in [`tbl/day-2-irat.md`](../tbl/day-2-irat.md) |
...
1. iRAT / tRAT on core concepts (definition vs KI aims; raw vs derived; FAIR vs open; method-agnostic documentation bar).
