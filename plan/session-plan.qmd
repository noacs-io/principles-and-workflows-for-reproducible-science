...
- [ ] **#10** Canvas module: **three** student pages (overview + Day 1 + Day 2 self-study; D038), SRC template in Files, paste targets on each day page — *drafts in [`canvas/`](../canvas/); publishing to the course room still required (#17)*
