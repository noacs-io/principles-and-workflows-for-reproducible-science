...
description: Review drafts or PRs against the teacher master, ILOs, must-ship backlog, and AGENTS.md. Use before merging teaching materials or when asked whether work is in scope for the two-day K9F5740 sessions.
---
...
1. [`plan/session-master.qmd`](../../../plan/session-master.qmd) — ILOs, endpoint, must-ship / defer, day run cues
...
- [ ] Versioning-friendly (Office Online + §6.1; Git optional where promised)
