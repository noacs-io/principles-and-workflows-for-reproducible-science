# Day 2 morning — self-study run sheet

**Time:** 09:00–12:00 (guided self-study).  
**Focus:** versioning, sharing boundaries, prepare own package for afternoon apps.  
**Outcomes:** 3 (versioning), 4–5 (prep for afternoon).

Carry forward Day 1’s Turing Way definition and caveats; do not invent a new principle vocabulary.

AI drafting and the four Day 2 DMP pastes happen in the **afternoon** applications (D036). Morning is reading and getting materials ready.
...
## Paste targets (afternoon, not this morning)
