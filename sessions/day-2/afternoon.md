...
| 15:20 | Inter-team **peer critique** against 5-year rubric + “could a classmate find matching text in your DMP draft?” | Score against the rubric | Fix DMP drafts if critique finds gaps |
...
- Do **not** run classic simultaneous report for these apps (D030). Zoom + own-project work: board posts for App 1, peer critique for App 2.
...
- 5-year rubric and templates (#11)
